...
local function saveAtlasConfig()
    ...
    -- Foca exclusivamente no caminho correto do screenshot
    pcall(function()
        if makefolder then makefolder("atlas") end
        writefile("atlas/default.json", configJSON)
    end)
    
    -- Backup em variáveis globais
    pcall(function()
