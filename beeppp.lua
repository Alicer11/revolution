...
local function saveAtlasConfig()
    ...
    local paths = {"AtlasBSS/config.json", "Atlas BSS/config.json", "Atlas/config.json", "AtlasBSS.json", "Atlas_BSS/config.json"}
    for _, path in ipairs(paths) do
        pcall(function()
            local folder = path:match("(.+)/")
            if folder and makefolder then makefolder(folder) end
